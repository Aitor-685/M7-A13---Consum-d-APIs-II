...
<body class="flex flex-col min-h-screen bg-gray-50 font-sans">
    ...
    <main class="container mx-auto px-4 py-8">
        ...
        if (!$categoria) {
            echo "<p class='text-red-500 text-center'>Categoria no trobada.</p>";
        } else {
        ?>
            <form action="modificarCategoria.proc.php" method="POST" class="max-w-lg mx-auto bg-white p-6 rounded-lg shadow-md">
