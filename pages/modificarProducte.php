...
<body class="flex flex-col min-h-screen bg-gray-50 font-sans">
    ...
    <main class="container mx-auto px-4 py-8">
        ...
        ?>
        <form action="modificarProducte.proc.php" method="POST" enctype="multipart/form-data" class="max-w-lg mx-auto bg-white p-6 rounded-lg shadow-md">
            ...
            <div class="mb-4">
                ...
                <input type="number" id="preu" name="preu" value="<?php echo htmlspecialchars($producte['prod_preu']); ?>" step="0.01" required class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
            </div>
